...
## Sistema Grid y el parámetro `mfrow`
...
### Grid con tres gráficos en una columna
...
### Layout con dos filas (Histogramas + Boxplot combinado)
...
## Uso de `layout()` con una matriz compleja de 4 elementos
